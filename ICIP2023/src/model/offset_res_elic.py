...
class Offset_ELIC(JointAutoregressiveHierarchicalPriors):
    def __init__(self, N=128, M=128, **kwargs):
        ...
        self.g_a1 = nn.Sequential(conv(32*3, N, kernel_size=5, stride=2),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),)
        
        self.g_a2 = nn.Sequential(conv(N+64*3, N, kernel_size=5, stride=2),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),)
        
        self.g_a3 = nn.Sequential(conv(N+96*3, M, kernel_size=5, stride=2),
        ...
        self.g_o3 = nn.Sequential(
            conv(N+96*2, N, kernel_size=3, stride=1),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
        ...
        self.g_s2 = nn.Sequential(
            conv(N+96*2, N, kernel_size=1, stride=1),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
        ...
        self.g_o2 = nn.Sequential(
            conv(N+64*2, N, kernel_size=3, stride=1),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            conv(N, 27*8*2, kernel_size=3, stride=1))
        ...
        self.g_s1 = nn.Sequential(
            conv(N+64*2, N, kernel_size=1, stride=1),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            deconv(N, N, kernel_size=5, stride=2),)
        ...
        self.g_o1 = nn.Sequential(
            conv(N+32*2, N, kernel_size=3, stride=1),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            conv(N, 27*8*2, kernel_size=3, stride=1))
...
class Res_ELIC(JointAutoregressiveHierarchicalPriors):
    def __init__(self, N=128, M=128, **kwargs):
        ...
        self.g_a0 = nn.Sequential(
            conv(3, N, kernel_size=5, stride=2),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),)
        
        self.g_a1 = nn.Sequential(conv(N+32*3, N, kernel_size=5, stride=2),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),)
        ...
        self.g_o3 = nn.Sequential(
            ...
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            conv(N, 96*2, kernel_size=3, stride=1))
        ...
        self.g_o2 = nn.Sequential(
            ...
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            conv(N, 64*2, kernel_size=3, stride=1))
        ...
        self.g_o1 = nn.Sequential(
            ...
            ResidualBottleneckBlock(N, N),
            ResidualBottleneckBlock(N, N),
            conv(N, 32*2, kernel_size=3, stride=1))
    ...
    def forward(self, x_current, f1, f2, f3, f1d, f2d, f3d, residual_temp, s):
        gain, hypergain, invhypergain, invgain = self.interpolate_gain(s)
        
        y = self.g_a0(x_current)
        y = self.g_a1(torch.cat([y, f1, f1d], dim=1))
