...
class BidirFlowRef(nn.Module):
    ...
    def __init__(self, n=6, N=128):
        ...
        self.flow_compressor = FlowCompressor(n=n, in_ch=19, out_ch=4, N=N)
    ...
    def forward(self, x_before, x_current, x_after, n=None, train=False):
        ...
        flow_result = self.flow_compressor(x_input, n, train)
        ...
        residual_result = self.residual_compressor(residual, n, train)
