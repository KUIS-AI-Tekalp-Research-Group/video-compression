...
class FlowCompressor(MeanScaleHyperprior):
    ...
    def __init__(self, n=6, in_ch=19, out_ch=5, N=128, **kwargs):
        ...
        self.gain_unit = Gain_Module(n=n, N=N, inv=False)
        self.inv_gain_unit = Gain_Module(n=n, N=N, inv=True)
        
        self.hyper_gain_unit = Gain_Module(n=n, N=N, inv=False)
        self.hyper_inv_gain_unit = Gain_Module(n=n, N=N, inv=True)
        
    def forward(self, x, n=None, train=False):
        self.training = train
        ...
        scaled_z_hat = self.hyper_inv_gain_unit(z_hat, n)
        ...
        scaled_y_hat = self.inv_gain_unit(y_hat, n)
...
class ResidualCompressor(MeanScaleHyperprior):
    ...
    def __init__(self, n=6, in_ch=3, N=128, **kwargs):
        super().__init__(N=N, M=N, **kwargs)
